defmodule TodoApi.UsersTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{full_name: nil, gender: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{full_name: "some full_name", gender: "some gender"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{full_name: "some updated full_name", gender: "some updated gender"}
